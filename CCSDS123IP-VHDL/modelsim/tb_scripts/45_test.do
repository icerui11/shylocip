...
vlib post_syn_lib
vcom -work shyloc_123 -93 -explicit  $SRC/modelsim/tb_stimuli/45_test/ccsds123_parameters.vhd
do $SRC/modelsim/tb_scripts/ip_core.do
#set tb test parameters
vcom -work work -93 -explicit $SRC/modelsim/tb_stimuli/45_test/ccsds123_tb_parameters.vhd
