...
vlib post_syn_lib
vcom -work shyloc_123 -93 -explicit  $SRC/modelsim/tb_stimuli/bip_test/ccsds123_parameters.vhd
vcom -work shyloc_121 -93 -explicit  $SRC/modelsim/tb_stimuli/bip_test/ccsds121_parameters.vhd
do $SRC/modelsim/tb_scripts/ip_core.do
do $SRC/modelsim/tb_scripts/ip_core_block.do
vcom -work work -93 -explicit $SRC/modelsim/tb_stimuli/bip_test/ccsds123_tb_parameters.vhd
vcom -work work -93 -explicit $SRC/modelsim/tb_stimuli/bip_test/ccsds121_tb_parameters.vhd
do $SRC/modelsim/tb_scripts/testbench_shyloc.do
vsim  work.ccsds_shyloc_tb(arch) -voptargs=+acc=bcglnprst+ccsds_shyloc_tb
